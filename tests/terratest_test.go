...
func TestFull(t *testing.T) {
	...
	instanceName := fmt.Sprintf("test-policies-thermal-%s", uniqueId)
...
`
	...
	iassert.AssertMOComply(t, fmt.Sprintf("/api/v1/thermal/Policies/%s", moid), expectedJSONTemplate, vars)
}
